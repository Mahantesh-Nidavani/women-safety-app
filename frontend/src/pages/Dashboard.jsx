...
const Dashboard = () => {
  ...
  localStorage.getItem('emergencyNumber') || '1'
    );
    ...
    <div className="grid grid-cols-2 gap-3 mt-6">
      <button
        onClick={() => {
          ...
          const locationLink = `https://www.google.com/maps?q=${location.lat},${location.lng}`;
          const message = `🚨 EMERGENCY! I need help! Location: ${locationLink}`;
          const smsLink = `sms:${contacts[0].phone}?body=${encodeURIComponent(message)}`;
          window.location.href = smsLink;
